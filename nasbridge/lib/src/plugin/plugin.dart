...
abstract class NasbridgePlugin<ClientType extends Nasbridge> {
  ...
  late final Expando<NyxxPluginState<ClientType, NasbridgePlugin<ClientType>>>
  ...
  Future<ClientType> doConnect(
      ...
      Future<ClientType> Function() connect) async {
  ...
  FutureOr<NyxxPluginState<ClientType, NasbridgePlugin<ClientType>>>
  ...
  FutureOr<void> beforeConnect(
      ApiOptions apiOptions, ClientOptions clientOptions) {}
  ...
  /// {@endtemplate}
  @mustCallSuper
  Future<HttpResponse> interceptRequest(ClientType client, HttpRequest request,
...
class NyxxPluginState<ClientType extends Nasbridge,
    PluginType extends NasbridgePlugin<ClientType>> {
